...
function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="container mx-auto min-h-[90vh] py-6 flex flex-col gap-4"
    >
      <Toaster richColors />
      ...
      <div className="border flex-1 flex flex-col xl:flex-row mx-4 xl:mx-0 xl:p-20 bg-secondary/50 rounded-2xl">
        <div className="flex-1 flex flex-col p-6 xl:p-20 gap-10 xl:gap-0">
          <div className="flex-1">
            ...
            <p className="text-base font-[300] mt-3 xl:mt-0">
          ...
          <div className="flex-1 pt-6 flex gap-4 justify-start items-center">
            <Link target="_blank" href="https://github.com/harshshah6">
              <Github
                size="24px"
                className="hover:size-7 transistion duration-300 cursor-pointer"
              />
            </Link>
            <Link
              target="_blank"
              href="https://www.linkedin.com/in/harsh-sandeep-shah-07a79b335/"
            >
              <LinkedinIcon
                size="24px"
                className="hover:size-7 transistion duration-300 cursor-pointer"
            ...
            <Link
              target="_blank"
              href="https://www.youtube.com/legendarystreamer"
            >
              <YoutubeIcon
                size="24px"
                className="hover:size-7 transistion duration-300 cursor-pointer"
            ...
            <Link
              target="_blank"
              href="https://www.instagram.com/harsh_.s._shah/"
            >
              <InstagramIcon
                size="24px"
                className="hover:size-7 transistion duration-300 cursor-pointer"
        ...
        <div className="flex-1 flex justify-center items-center p-2 xl:p-20">
          <form
            onSubmit={onSubmit}
            className="h-full flex-1 border bg-gray-100 dark:bg-white/10 p-2 xl:p-10 rounded-xl flex flex-col justify-evenly"
          >
            <div className="flex flex-col gap-4">
              <div>
                ...
                <Input
                  ...
                  id="name"
                  placeholder="Name"
                  className="mt-2 outline outline-secondary-foreground outline-1"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  id="message"
                  placeholder=""
                  className="mt-2 outline outline-secondary-foreground outline-1 min-h-20"
                  required
                />
              </div>
            </div>
            ...
            <LoadingButton
              type="submit"
              className="font-sans place-self-end mt-8"
              loading={isButtonLoading}
            >
              {isButtonLoading ? "Please wait..." : "Send Message"}
            </LoadingButton>
          </form>
        </div>
      </div>
