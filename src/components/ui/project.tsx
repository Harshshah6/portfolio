...
export default function Project({
  ...
  return (
    ...
    >
      <Link href={"/project/" + index} className="">
        <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative hover:bg-gray-200 transition sm:group-even:pl-8 sm:h-[50vh] md:h-full dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
